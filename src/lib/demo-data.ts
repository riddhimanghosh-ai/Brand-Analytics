...
// ─── Events & Campaigns (demo) ───────────────────────────────────────────────
export const demoEvents = [
  {
    id: 'ev_01',
    title: 'Diwali Flash Sale',
    type: 'flash_sale' as const,
    description: '30% off sitewide + free shipping. Biggest sale of the year — pushed via email, paid ads, and WhatsApp.',
    startDate: daysAgo(45),
    endDate: daysAgo(40),
    audience: 'all' as const,
    channels: ['email', 'paid_ads', 'whatsapp', 'instagram'],
    tags: ['festive', 'sitewide'],
    discountValue: 30,
    discountUnit: 'pct' as const,
    revenueTarget: 90000,
    notes: 'Launched 2 days ahead of Dhanteras. DIWALI30 code.',
  },
  {
    id: 'ev_02',
    title: 'Influencer Keshav Campaign',
    type: 'other' as const,
    description: 'Paid partnership with Keshav (@keshavtech, 1.2M). 3 dedicated reels + stories over 8 days.',
    startDate: daysAgo(30),
    endDate: daysAgo(23),
    audience: 'campaign' as const,
    audienceDetails: 'Top-of-funnel new audience via Keshav\'s Instagram + YouTube',
    channels: ['instagram', 'paid_ads'],
    tags: ['influencer', 'ugc'],
    revenueTarget: 80000,
    notes: 'KESHAV15 code tracked separately. Strong awareness, weak direct conversion.',
  },
  {
    id: 'ev_03',
    title: 'Black Friday Weekend',
    type: 'discount_pct' as const,
    description: '25% off + BOGO on earbuds. 4-day sale. Biggest order volume spike ever recorded.',
    startDate: daysAgo(15),
    endDate: daysAgo(12),
    audience: 'all' as const,
    channels: ['email', 'paid_ads', 'whatsapp', 'website'],
    tags: ['bfcm', 'sitewide'],
    discountValue: 25,
    discountUnit: 'pct' as const,
    revenueTarget: 100000,
    notes: 'Early-access email sent 48h before. Upsell to SmartWatch +22% attach rate.',
  },
  {
    id: 'ev_04',
    title: 'Christmas Campaign',
    type: 'bundle' as const,
    description: 'Gift bundle — Earbuds + SmartWatch + carry case at ₹2999 (save ₹800). Positioned as the "perfect gift".',
    startDate: daysAgo(7),
    endDate: daysAgo(0),
    audience: 'all' as const,
    channels: ['email', 'instagram', 'paid_ads', 'website'],
    tags: ['gifting', 'bundle'],
    discountValue: 800,
    discountUnit: 'fixed' as const,
    revenueTarget: 75000,
    notes: 'Gift-wrapping add-on available at checkout. Repeat customer share higher than usual.',
  },
  {
    id: 'ev_05',
    title: 'New Year Countdown',
    type: 'flash_sale' as const,
    description: '40% off for 72 hours only. Starts 29 Dec — "ring in the new year" messaging. Email + paid.',
    startDate: daysAgo(-7),
    endDate: daysAgo(-3),
    audience: 'all' as const,
    channels: ['email', 'paid_ads', 'whatsapp'],
    tags: ['new-year', 'flash'],
    discountValue: 40,
    discountUnit: 'pct' as const,
    revenueTarget: 120000,
    notes: 'Countdown timer on homepage. Pre-launch waitlist of 1,200 emails.',
  },
  {
    id: 'ev_06',
    title: 'Loyalty Double Points Weekend',
    type: 'loyalty' as const,
    description: 'Existing customers earn 2× loyalty points on all purchases. Exclusive early access 12h before public.',
    startDate: daysAgo(60),
    endDate: daysAgo(58),
    audience: 'specific' as const,
    audienceDetails: 'Loyalty members with ≥1 prior purchase',
    channels: ['email', 'whatsapp'],
    tags: ['loyalty', 'retention'],
    revenueTarget: 35000,
    notes: 'Sent to 4,800 loyalty members. Highest email open rate this year at 44%.',
  },
];
