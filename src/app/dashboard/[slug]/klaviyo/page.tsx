  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: '15px', color: 'var(--text-muted)', lineHeight: 1.7, maxWidth: '420px' }}>
        Klaviyo email marketing analytics — open rates, click rates, revenue attribution, and campaign performance. This feature is being set up for Hira Fragrances.
      </p>
    </div>
  );
}
